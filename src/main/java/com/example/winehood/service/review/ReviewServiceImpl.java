...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public List<ReviewDto> findAllReviewsByWineId(Long wineId) {
        List<Review> commentListFromDb = reviewRepository.findAllByWineId(wineId);
        return reviewMapper.toDtoList(commentListFromDb);
    }
}
